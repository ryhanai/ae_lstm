...
class AutoencoderWithCrop(tf.keras.Model):
    ...
    def test_step(self, data):
        ...
        self.test_trackers['image_loss'].update_state(val_image_loss)
        self.test_trackers['joint_loss'].update_state(val_joint_loss)
        self.test_trackers['loss'].update_state(val_loss)
