...
#         #tf.keras.layers.Dense(self.dense_dim, activation='selu'),
...
#         tf.keras.layers.Conv2DTranspose(32, kernel_size=3, strides=2, padding='same', activation='selu'),
#         tf.keras.layers.BatchNormalization(),
#         # tf.keras.layers.UpSampling2D(),
...
#         tf.keras.layers.Conv2DTranspose(8, kernel_size=3, strides=2, padding='same', activation='selu'),
#         tf.keras.layers.BatchNormalization(),
#         # tf.keras.layers.UpSampling2D(),
