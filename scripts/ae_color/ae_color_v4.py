...
def model():
    ...
    x = tf.keras.layers.Conv2DTranspose(32, kernel_size=3, strides=1, padding='same', activation='selu')(dc4)
    x = tf.keras.layers.UpSampling2D()(x) # 10,20,32
