...
class SIM_ROI(SIM):
    ...
    def create_water(self, num_droplets = 180, radius=0.005):
        self.radius = radius
        self.droplets = [create_sphere(radius, mass=0.01) for _ in range(num_droplets)] # kg

    def fill_water(self, pos=np.array([-0.14, -0.63, 1.1])):
        # [-0.14, -0.63, 1.02]
        # [0.27, -0.65, 0.9] glass
